        ...
        <div class="col-span-12 xxl:col-span-9 grid grid-cols-12 gap-6">
            ...
            <div class="col-span-12 xl:col-span-8 mt-6">
                ...
                <div class="intro-y box p-5 mt-12 sm:mt-5">
                    ...
                    <div class="report-maps mt-5 bg-gray-200 rounded-md" data-center="-6.2425342, 106.8626478" data-sources="/{{asset('admin/json/location.json')}}"></div>
                </div>
            </div>
            <!-- END: Official Store -->
            ...
            <div class="col-span-12 xl:col-span-4 mt-6">
                ...
                <div class="mt-5">
                    <div class="intro-y">
                        <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                            <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                <img alt="Midone Tailwind HTML Admin Template" src="{{asset('admin\images\profile-3.jpg')}}">
                            </div>
                    ...
                    <div class="intro-y">
                        <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                            <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                <img alt="Midone Tailwind HTML Admin Template" src="{{asset('admin\images\profile-12.jpg')}}">
                            </div>
                            <div class="ml-4 mr-auto">
                    ...
                    <div class="intro-y">
                        <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                            <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                <img alt="Midone Tailwind HTML Admin Template" src="{{asset('admin\images\profile-6.jpg')}}">
                            </div>
                            <div class="ml-4 mr-auto">
                    ...
                    <div class="intro-y">
                        <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                            <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                <img alt="Midone Tailwind HTML Admin Template" src="{{asset('admin\images\profile-9.jpg')}}">
                            </div>
                            <div class="ml-4 mr-auto">
                    ...
                    <table class="table table-report sm:mt-2">
                            ...
                            <td class="w-40">
                                <div class="flex">
                                    <div class="w-10 h-10 image-fit zoom-in">
                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{asset('admin\images\preview-12.jpg')}}" title="Uploaded at 20 September 2022">
                                    </div>
                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{asset('admin\images\preview-7.jpg')}}" title="Uploaded at 21 October 2020">
                                    </div>
                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{asset('admin\images\preview-10.jpg')}}" title="Uploaded at 8 May 2022">
                                    </div>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr class="intro-x">
                            <td class="w-40">
                                <div class="flex">
                                    <div class="w-10 h-10 image-fit zoom-in">
                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{asset('admin\images\preview-15.jpg')}}" title="Uploaded at 23 June 2022">
                                    </div>
                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{asset('admin\images\preview-2.jpg')}}" title="Uploaded at 13 September 2021">
                                    </div>
                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{asset('admin\images\preview-15.jpg')}}" title="Uploaded at 14 June 2022">
                                    </div>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr class="intro-x">
                            <td class="w-40">
                                <div class="flex">
                                    <div class="w-10 h-10 image-fit zoom-in">
                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{asset('admin\images\preview-2.jpg')}}" title="Uploaded at 27 November 2022">
                                    </div>
                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{asset('admin\images\preview-1.jpg')}}" title="Uploaded at 20 June 2020">
                                    </div>
                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{asset('admin\images\preview-8.jpg')}}" title="Uploaded at 31 August 2021">
                                    </div>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr class="intro-x">
                            <td class="w-40">
                                <div class="flex">
                                    <div class="w-10 h-10 image-fit zoom-in">
                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{asset('admin\images\preview-1.jpg')}}" title="Uploaded at 12 September 2022">
                                    </div>
                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{asset('admin\images\preview-11.jpg')}}" title="Uploaded at 18 August 2021">
                                    </div>
                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{asset('admin\images\preview-8.jpg')}}" title="Uploaded at 18 May 2022">
                                    </div>
                                </div>
                            </td>
                            <td>
                ...
                <div class="col-span-12 md:col-span-6 xl:col-span-4 xxl:col-span-12 mt-3">
                    ...
                    <div class="report-timeline mt-5 relative">
                                ...
                                <div class="text-gray-600">
                                    ...
                                    <div class="flex mt-2">
                                        <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Samsung Galaxy S20 Ultra">
                                            <img alt="Midone Tailwind HTML Admin Template" class="rounded-md border border-white" src="{{asset('admin\images\preview-9.jpg')}}">
                                        </div>
                                        <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Sony Master Series A9G">
                                            <img alt="Midone Tailwind HTML Admin Template" class="rounded-md border border-white" src="{{asset('admin\images\preview-12.jpg')}}">
                                        </div>
                                        <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Nike Tanjun">
                                            <img alt="Midone Tailwind HTML Admin Template" class="rounded-md border border-white" src="{{asset('admin/images/preview-13.jpg')}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="intro-x relative flex items-center mb-3">
                            <div class="report-timeline__image">
                                <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                    <img alt="Midone Tailwind HTML Admin Template" src="{{asset('admin\images\profile-7.jpg')}}">
                                </div>
                            </div>
                            <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                <div class="flex items-center">
                                ...
                                <div class="text-gray-600 mt-1">Has changed <a class="text-theme-1" href="">Nike Tanjun</a> price and description</div>
                            </div>
                        </div>
                        <div class="intro-x relative flex items-center mb-3">
                            <div class="report-timeline__image">
