...
{{--            </li>--}}
            <li>
                <a href="{{route('acategory')}}" class="side-menu">
                    <div class="side-menu__icon"> <i data-feather="inbox"></i> </div>
                    <div class="side-menu__title"> New Category </div>
                </a>
            </li>
            <li>
                <a href="{{route('items')}}" class="side-menu">
            ...
            <div class="intro-x relative mr-3 sm:mr-6">
                ...
                <div class="search-result">
                    <div class="search-result__content">
                        ...
                        <div class="mb-5">
                            <a href="" class="flex items-center mt-2">
                                <div class="w-8 h-8 image-fit">
                                    <img alt="Midone Tailwind HTML Admin Template" class="rounded-full" src="{{asset('admin\images\profile-5.jpg')}}">
                                </div>
                            ...
                            <a href="" class="flex items-center mt-2">
                                <div class="w-8 h-8 image-fit">
                                    <img alt="Midone Tailwind HTML Admin Template" class="rounded-full" src="{{asset('admin\images\profile-7.jpg')}}">
                                </div>
                            ...
                            <a href="" class="flex items-center mt-2">
                                <div class="w-8 h-8 image-fit">
                                    <img alt="Midone Tailwind HTML Admin Template" class="rounded-full" src="{{asset('admin\images\profile-9.jpg')}}">
                                </div>
                                <div class="ml-3">Al Pacino</div>
                                <div class="ml-auto w-48 truncate text-gray-600 text-xs text-right">alpacino@left4code.com</div>
                            </a>
                        ...
                        <a href="" class="flex items-center mt-2">
                            <div class="w-8 h-8 image-fit">
                                <img alt="Midone Tailwind HTML Admin Template" class="rounded-full" src="{{asset('admin\images\preview-8.jpg')}}">
                            </div>
                        ...
                        <a href="" class="flex items-center mt-2">
                            <div class="w-8 h-8 image-fit">
                                <img alt="Midone Tailwind HTML Admin Template" class="rounded-full" src="{{asset('admin\images\preview-11.jpg')}}">
                            </div>
                    ...
                    <div class="notification-content__box dropdown-box__content box">
                        ...
                        <div class="cursor-pointer relative flex items-center ">
                            ...
                            <div class="ml-2 overflow-hidden">
                                ...
                                <div class="w-full truncate text-gray-600">It is a long established fact that a reader will be dist adminracted by the readable content of a page when looking at its layout. The point of using Lorem </div>
                            </div>
                        </div>
...
<script src="{{asset('admin/js/app.js?v=1')}}"></script>
<!-- END: JS Assets-->
</body>
</html>
